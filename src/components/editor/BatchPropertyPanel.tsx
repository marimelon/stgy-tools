          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <SliderInput
                ...
                onBlur={() =>
                  onCommitHistory(t("batchProperty.rotationChanged", "回転変更"))
                }
              />
            </div>
            {/* サイズ */}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <SliderInput
                ...
                onBlur={() =>
                  onCommitHistory(t("batchProperty.opacityChanged", "透過度変更"))
                }
              />
            </div>
          </div>
          ...
          <div className="space-y-2.5">
            ...
            {flipFlags.horizontal && (
              <div className="flex items-center justify-between">
                ...
                />
                {isMixed(batchValues.flags.flipHorizontal) && <MixedIndicator />}
              </div>
            )}
            {/* 上下反転 */}
            {flipFlags.vertical && (
...
function ObjectSpecificParams({
  ...
  return (
    <PropertySection title={t("batchProperty.specificParams", "固有パラメータ")}>
      <div className="space-y-3">
            ...
            <div key={paramId} className="space-y-2">
              ...
              {paramDef.useSlider ? (
                <SliderInput
                  ...
                  onBlur={() =>
                    onCommitHistory(`${paramDef.name}${t("batchProperty.changed", "変更")}`)
                  }
                />
              ) : (
                <NumberInput
