 ...
 */
export function shiftGroupIndices(groups: ObjectGroup[], count: number): ObjectGroup[] {
 ...
 * オブジェクト削除時にグループを更新
 */
export function updateGroupsAfterDelete(groups: ObjectGroup[], deletedIndices: number[]): ObjectGroup[] {
