...
export const EDIT_PARAMS: Record<number, EditParamDefinition> = {
  ...
  [EditParamIds.Height]: { name: "縦幅", defaultValue: 128, min: 16, max: 384, useSlider: true },
  [EditParamIds.Width]: { name: "横幅", defaultValue: 128, min: 16, max: 512, useSlider: true },
  [EditParamIds.ConeAngle]: { name: "範囲角度", defaultValue: 90, min: 10, max: 360, useSlider: true },
  [EditParamIds.DonutRange]: { name: "ドーナツ範囲", defaultValue: 50, min: 0, max: 240, useSlider: true },
  [EditParamIds.DisplayCount]: { name: "表示数", defaultValue: 1, min: 1, max: 5, useSlider: true },
  [EditParamIds.HeightCount]: { name: "縦幅数", defaultValue: 1, min: 1, max: 5, useSlider: true },
  [EditParamIds.WidthCount]: { name: "横幅数", defaultValue: 1, min: 1, max: 5, useSlider: true },
  [EditParamIds.LineWidth]: { name: "線幅", defaultValue: 6, min: 2, max: 10, useSlider: true },
